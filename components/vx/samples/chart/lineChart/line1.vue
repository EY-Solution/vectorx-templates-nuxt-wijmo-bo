<template>
  <v-card>
    ...
    <template #text>
      ...
      <VxMarkdownViewer>{{ line1 }}</VxMarkdownViewer>
    </template>
  </v-card>
</template>

<script setup lang="ts">
import { WjFlexChart, WjFlexChartLegend, WjFlexChartAxis, WjFlexChartSeries, WjFlexChartAnimation } from '#vectorx/nuxt-wijmo/components'
