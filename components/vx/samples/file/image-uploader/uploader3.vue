<template>
  <VCard>
    <template #text>
      ...
      <VxImageUploader ref="uploader" fileGroupId="vx-sample-image" v-model:fileId="fileId" :readonly="true" :width="500" :height="500" />
...
import { VxMarkdownViewer, VxWjInputMask } from '#vectorx/nuxt-wijmo/components'
