  ...
  <VCard>
    <template #text>
      ...
      <WjFlexGrid :itemsSource="data" :initialized="grid.initialize" class="mt-3">
        <WjFlexGridColumn header="시스템코드" binding="sysCd" :dataMap="createVxCodeDataMap('SYS_CD')" :isReadOnly="false"></WjFlexGridColumn>
        <WjFlexGridColumn
          header="사용자구분코드"
          binding="useDvCd"
          :dataMap="createVxCodeDataMap('USE_DV_CD', '없음.')"
          :isReadOnly="false"
        ></WjFlexGridColumn>
      </WjFlexGrid>
...
import { WjFlexGrid, WjFlexGridColumn, VxMarkdownViewer } from '#vectorx/nuxt-wijmo/components'
import { createVxCodeDataMap } from '#vectorx/nuxt-wijmo/management/composables'
...
const customerMap = createVxCodeDataMap('SYS_CD')
