<template>
  <VCard>
    <template #text>
      ...
      <VxButton text="초기화" @click="grid.editing.clearHighlightChanges" />
...
import { WjFlexGrid, VxMarkdownViewer, WjFlexGridColumn, VxButton } from '#vectorx/nuxt-wijmo/components'
