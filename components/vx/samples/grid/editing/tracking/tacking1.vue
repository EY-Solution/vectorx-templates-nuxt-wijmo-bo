<template>
  <VCard>
    <template #text>
      ...
      <VxButton @click="() => (displayData = grid.collectionView.itemsAdded)" text="추가 데이터 조회"></VxButton>
      <VxButton @click="() => (displayData = grid.collectionView.itemsRemoved)" text="삭제 데이터 조회"></VxButton>
