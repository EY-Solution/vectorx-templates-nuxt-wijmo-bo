<template>
  <VCard>
    ...
    <template #text>
      ...
      <VxButton text="체크 Row 삭제" @click="grid.checkSelection.removeRows" :disabled="grid.checkSelection.rows.value.length < 1"></VxButton>
      ...
      <VxMarkdownViewer :content="selection2" />
    </template>
  </VCard>
</template>
