<template>
  <VCard>
    ...
    <template #text>
      ...
      <VxCheckGroupBox :itemsSource="[{ text: 'autoSelection' }]" v-model="grid.option.autoSelection"></VxCheckGroupBox>
      ...
      <VxButton text="Load Data" @click="() => loadData()" />
      <VxButton text="Clear Data" @click="() => (gridData = [])" />

      <VxMarkdownViewer :content="content" />
    </template>
  </VCard>
</template>
<script lang="ts" setup>
import { ref } from '#vectorx/nuxt'
import { WjFlexGrid, WjFlexGridColumn, VxButton, VxCheckGroupBox, VxMarkdownViewer } from '#vectorx/nuxt-wijmo/components'
