<template>
  <VCard>
    <template #text>
      <h3>Header Grouping</h3>
      <VxMarkdownViewer :content="header1_1" />
      ...
      <VxMarkdownViewer :content="header1_2" />
    </template>
  </VCard>
</template>
<script lang="ts" setup>
import { ref } from '#vectorx/nuxt'
import { WjFlexGrid, WjFlexGridColumnGroup, VxMarkdownViewer } from '#vectorx/nuxt-wijmo/components'

// @ts-ignore
import header1_1 from './md/header1-1.md'

// @ts-ignore
import header1_2 from './md/header1-2.md'
