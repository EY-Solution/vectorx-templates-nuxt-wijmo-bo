<template>
  <VCard>
    <template #text>
      ...
      <WjFlexGrid :itemsSource="data" :initialized="grid.initialize" class="mt-2">
        <WjFlexGridColumn header="Col1" binding="col1" :wordWrap="true" :width="200">
          <wj-flex-grid-cell-template cellType="Cell" v-slot="cell">
            <div>
              <VxButtonBox>
                <VxButton small type="primary" text="저장" :width="80" />
                <VxButton small type="gray" text="삭제" :width="80" />
              </VxButtonBox>
            </div>
      ...
      <VxMarkdownViewer :content="cellTemplate3" />
    </template>
  </VCard>
</template>
<script lang="ts" setup>
import { WjFlexGrid, WjFlexGridColumn, WjFlexGridCellTemplate, VxMarkdownViewer, VxButton, VxButtonBox } from '#vectorx/nuxt-wijmo/components'
