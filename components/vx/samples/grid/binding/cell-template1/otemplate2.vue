      ...
      <WjFlexGrid :itemsSource="data" :initialized="grid.initialize" class="mt-2">
        <WjFlexGridColumn header="Col1" binding="col1" :wordWrap="true">
          <wj-flex-grid-cell-template cellType="Cell" v-slot="cell">
            <img src="@vectorx/nuxt-wijmo/src/samples/assets/img/avatar1.png" style="height: 100px" v-if="cell.item.index === 0" />
            <img src="@vectorx/nuxt-wijmo/src/samples/assets/img/avatar2.png" style="height: 100px" v-if="cell.item.index === 1" />
            <img src="@vectorx/nuxt-wijmo/src/samples/assets/img/avatar3.png" style="height: 100px" v-if="cell.item.index === 2" />
          </wj-flex-grid-cell-template>
        </WjFlexGridColumn>
        <WjFlexGridColumn header="Col2" binding="col2" />
      </WjFlexGrid>

      <VxMarkdownViewer :content="cellTemplate2" />
    </template>
  </VCard>
</template>
<script lang="ts" setup>
import { WjFlexGrid, WjFlexGridColumn, WjFlexGridCellTemplate, VxMarkdownViewer } from '#vectorx/nuxt-wijmo/components'
