<template>
  <VCard>
    <template #text>
      <h3 class="mb-2">Grouped Header</h3>
      grid.export.toExcel 메소드를 사용하면 Grouping된 헤더 정보를 포함하여 엑셀을 다운로드 받을 수 있다.
      ...
      <VxButton text="Export Excel" @click="() => grid.export.toExcel('DownloadExcel.xlsx')"></VxButton>
