<template>
  <VCard>
    ...
    <template #text>
      ...
      <VxMarkdownViewer :content="selection4" />
    </template>
  </VCard>
</template>
...
import { useWjGridCheckBoxSelection, useCollectionView } from '#vectorx/nuxt-wijmo/composables'
