<template>
  <VCard>
    ...
    <template #text>
      ...
      <br />
      <VxButton text="Clear Selection" @click="() => gridControl.select(-1, -1)" />
      <br />
      ...
      <VxMarkdownViewer :content="selection1" />
    </template>
  </VCard>
</template>
<script lang="ts" setup>
import { reactive, shallowRef } from '#vectorx/nuxt'
import { WjFlexGrid, WjFlexGridColumn, VxButton } from '#vectorx/nuxt-wijmo/components'
import { useWjGridSelectionData } from '#vectorx/nuxt-wijmo/composables'
