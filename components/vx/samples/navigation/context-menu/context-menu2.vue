<template>
  <VCard>
    ...
    <template #text>
      ...
      <VxButton text="활성화" :disabled="!isActivatedContextMenu" @click="activateContextMenu" />
      <VxButton text="비활성화" :disabled="isActivatedContextMenu" @click="deactivateContextMenu" />
      ...
      <VxMarkdownViewer :content="contextMenu2" />
    </template>
  </VCard>
</template>
<script lang="ts" setup>
import { shallowRef, computed } from '#vectorx/nuxt'
import { WjMenu, WjMenuItem, WjMenuSeparator, WjFlexGrid, WjFlexGridColumn, VxButton } from '#vectorx/nuxt-wijmo/components'
import { useWjContextMenu } from '#vectorx/nuxt-wijmo/composables'
