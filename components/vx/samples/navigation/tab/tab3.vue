<template>
  <VCard>
    ...
    <VxButton text="toggle disabled" @click="() => (tabData[0].disabled = !tabData[0].disabled)" />
    <VxButton text="toggle visible" @click="() => (tabData[0].visible = !tabData[0].visible)" />

    <VxMarkdownViewer :content="tab3" />
  </VCard>
</template>
