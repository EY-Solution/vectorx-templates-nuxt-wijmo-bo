<template>
  <div>
    ...
    <v-card>
      ...
      <template #subtitle> VxIpAddressTextBox를 사용하여 IP 입력 처리를 할 수 있다. </template>
      <template #text>
        <div>
        ...
        <br />
        <VxMarkdownViewer>{{ ipAddress1 }}</VxMarkdownViewer>
      </template>
    </v-card>
    <v-card>
      <template #title> 목록 입력 </template>
      <template #subtitle> VxIpAddressListBox를 사용하여 IP 목록의 입력 처리를 할 수 있다. </template>
      <template #text>
        <div>
        ...
        <br />
        <VxMarkdownViewer>{{ ipAddress2 }}</VxMarkdownViewer>
      </template>
    </v-card>
  </div>
</template>
