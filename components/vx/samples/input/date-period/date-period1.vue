<template>
  <v-card>
    <template #text>
      VxDatePeriodBox 컴포넌트를 사용하여 일자 기간 입력을 처리할 수 있다. <br /><br />
      <div class="samplebox">
        ...
        <VxButton text="배열 일자 반영" @click="dateArr1 = ['20220507', '20221009']"></VxButton>
        <VxButton text="배열 null 반영" @click="dateArr1 = [null, null]"></VxButton>
...
import { VxButton, VxDatePeriodBox } from '#vectorx/nuxt-wijmo/components'
