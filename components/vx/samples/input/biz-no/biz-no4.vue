<template>
  <v-card>
    <template #text>
      <h3>Validation</h3>
      <br />
      VxValidationGroup 컴포넌트 내에 위치할 경우, 법인 번호의 유효성을 체크할 수 있다.
...
import { VxCorpNoBox, VxValidationGroup, VxButton, VxMarkdownViewer } from '#vectorx/nuxt-wijmo/components'
